...
if(!level_complete)
{
	...
	draw_sprite_ext(spr_time_box,sprite_index,xx+gui_xoff,yy+gui_yoff,2*(Camera_Controller.gui_scale),2*(Camera_Controller.gui_scale),image_angle,image_blend,image_alpha)
	//draw gui
